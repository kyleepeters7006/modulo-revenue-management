 ...
 * The attached executive workbook template establishes a fixed three-page
 * landscape contract.
    ...
    lines: serviceLines.map((serviceLine, index) => ({
      ...
      currentPlan: {
        ...
        residentIncreaseDistribution: [
          ...
          { label: "3.0%", count: 0 },
          { label: "3.5%", count: 0 },
          { label: "4.0%", count: index === 0 ? 2 : 0 },
          { label: "4.5%", count: 0 },
          { label: "5.0%", count: 0 },
          { label: "5.5%", count: 0 },
          { label: "6.0%", count: 4 + index },
          { label: "6.5%", count: 0 },
          { label: "7.0%", count: 0 },
          { label: "7.5%", count: 0 },
          { label: "8.0%", count: 0 },
          { label: "8.5%", count: 0 },
          { label: "9.0%+", count: index === 5 ? 1 : 0 },
        ],
      },
...
assert.equal(
  ...
  3,
  "annual report PDF is exactly three pages",
);
