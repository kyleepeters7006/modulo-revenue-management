      ...
      try {
        ...
        if (data.status === 'completed') {
          ...
          toast({
            ...
            description: data.error || "Failed to apply Rules Rate calculation. Please try again.",
            variant: "destructive",
          });
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-2">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600" data-testid="text-page-subtitle">
                Review current rates and apply saved pricing rules to units. Rules are created in Pricing Controls.
              </p>
            </div>
