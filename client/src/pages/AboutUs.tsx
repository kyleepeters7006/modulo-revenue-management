...
import { Linkedin, FileText, Building2, ArrowLeft, BookOpen, ChevronRight } from "lucide-react";
          ...
          <Card className="border-2 border-[var(--trilogy-teal)] bg-gradient-to-r from-[var(--trilogy-teal)]/10 to-[var(--trilogy-dark-blue)]/10 hover:from-[var(--trilogy-teal)]/20 hover:to-[var(--trilogy-dark-blue)]/20 transition-colors cursor-pointer">
            <CardContent className="p-6 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[var(--trilogy-teal)]/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--trilogy-grey)] mt-1">
                    How the pricing engine works · The Rules Engine &amp; Guardrails · Dynamic vs Traditional modes · AI learning system · Revenue targets
                  </p>
                </div>
              </div>
              <ChevronRight className="h-6 w-6 text-[var(--trilogy-teal)] flex-shrink-0 ml-4" />
            </CardContent>
          </Card>
        </button>
