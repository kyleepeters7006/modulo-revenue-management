...
export default function AboutUs() {
  ...
  const videos = {
    overview: {
      ...
      source: "/media/modulo-pricing-intelligence.mp4?v=20260917-voice-sync-refresh",
    ...
    annual: {
      ...
      source: "/media/modulo-annual-increase-process.mp4?v=20260917-aligned-highlights-refresh",
