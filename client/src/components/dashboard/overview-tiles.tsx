            ...
            {overviewData.occupancyByServiceLine?.map((serviceLine) => (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-bold !text-black dark:!text-white" style={{ color: '#000000' }}>
                ...
                <div className="text-sm !text-black dark:!text-gray-200 font-medium mb-2" style={{ color: '#000000' }}>
                ...
                <div className="space-y-1 text-xs">
                  <div className="flex justify-between">
                    <span className="!text-black dark:!text-gray-200 font-semibold" style={{ color: '#000000' }}>Avg Rate:</span>
                    <span className="font-bold !text-black dark:!text-white" style={{ color: '#000000' }}>{formatCurrency(Math.round(serviceLine.avgRate || 0))}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="!text-black dark:!text-gray-200 font-semibold" style={{ color: '#000000' }}>Competitor Rate:</span>
                    <span className="font-bold !text-black dark:!text-white" style={{ color: '#000000' }}>{formatCurrency(Math.round(serviceLine.avgCompetitorRate || 0))}</span>
                  </div>
                        ...
                        <table className="w-full text-xs">
                          <thead>
                            <tr className="border-b border-[var(--dashboard-border)]">
                              <th className="text-left font-medium text-[var(--dashboard-muted)] pb-1">Service</th>
                              <th className="text-center font-medium text-[var(--dashboard-muted)] pb-1">Units</th>
