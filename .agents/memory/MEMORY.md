...
- [In-house rate planning solver](inhouse-rate-planning-solver.md) — base-rate-only cohorts; mix-standardize YoY; resident increases vary by street variance up to the configured maximum.
